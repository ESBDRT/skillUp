  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      ...
      {slideNumber && totalSlides && (
        <div className="text-[10px] sm:text-xs text-muted-foreground mb-2 text-center">
          {slideNumber} / {totalSlides}
        </div>
      )}
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-base sm:text-lg md:text-xl font-bold text-foreground leading-tight break-words hyphens-auto line-clamp-2">
            {card.title}
          </h2>
        </div>
      </motion.div>
