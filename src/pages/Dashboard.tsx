      ...
      <main className="px-4 pt-6">
        ...
        delay: 0.2
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`text-sm font-medium px-3 py-1 rounded-full ${isOnTrack ? 'bg-success/10 text-success' : 'bg-destructive/10 text-destructive'}`}>
        ...
        delay: 0.3
          ...
          <button onClick={() => navigate('/create')} className="flex items-center gap-3 p-4 bg-card rounded-2xl shadow-card border border-border hover:border-primary transition-colors">
            <div className="p-2 bg-primary/10 rounded-xl">
              <Plus className="w-5 h-5 text-primary" />
            </div>
            <span className="font-medium text-foreground">Créer un cours</span>
          </button>
          <button onClick={() => navigate('/brain')} className="flex items-center gap-3 p-4 bg-card rounded-2xl shadow-card border border-border hover:border-primary transition-colors">
            <div className="p-2 bg-primary/10 rounded-xl">
